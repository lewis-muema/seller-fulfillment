  ...
  state() {
    return {
      ...
      transactionTypes: [
        ...
        {
          name: "payments.earningFromASaleOfGoods",
          value: "EARNING_FROM_SALE_OF_GOOD",
        },
        {
          name: "payments.earningFromAWithdrawalRefund",
          value: "EARNING_FROM_WITHDRAWAL_REFUND",
        },
        {
          name: "payments.fulfillmentFeePayment",
          value: "FULFILMENT_FEE_PAYMENT",
        },
        {
          name: "payments.upcomingEarningFromASaleOfGoods",
          value: "UPCOMING_EARNING_FROM_SALE_OF_GOOD",
        },
        {
          name: "payments.withdrawalOfEarnings",
          value: "WITHDRAWAL_OF_EARNING",
        },
        {
          name: "payments.fulfillmentFeeCost",
          value: "FULFILMENT_FEE_COST",
        },
        {
          name: "payments.withdrawalOfEarningCost",
